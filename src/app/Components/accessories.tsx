    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 text-lg">Complete your look with our premium collection of accessories</p>
        </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-col gap-2">
                  {["watches", "belts", "wallets", "sunglasses", "bags", "jewelry"].map((category) => (
...
export default memo(AccessoriesPage);